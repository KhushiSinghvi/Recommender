$(function() {
  ...
  $('.movie-button').on('click',function(){
    var my_api_key = 'f66214d11064f1cc8757f9eacf05925a';
    var title = $('.movie').val();
    if (title=="") {
...
function show_details(movie_details,arr,movie_title,my_api_key,movie_id){
  ...
  //var imdb_link = movie_details.imdb_link;
  var poster = 'https://image.tmdb.org/t/p/original'+movie_details.poster_path;
  var yt = 'http://api.themoviedb.org/3/movie/'+imdb_id+'?api_key='+my_api_key+'&append_to_response=videos';
